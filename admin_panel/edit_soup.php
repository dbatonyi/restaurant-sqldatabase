...
<?php 
    ...
    if(isset($_GET['edit_soup'])){
        ...
        $edit_id = $_GET['edit_soup'];
        
        $get_p = "select * from levesek where food_id='$edit_id'";
    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Edit Soup
        ...
        <div class="panel panel-default">
           ...
           <div class="panel-heading">
               ...
               <h3 class="panel-title">
                   ...
                   <i class="fa fa-money fa-fw"></i> Edit Soup
...
if(isset($_POST['update'])){
    ...
    $update_product = "update levesek set food_name='$product_title' ,food_desc='$product_keywords',food_price='$product_desc' where food_id='$p_id'";
