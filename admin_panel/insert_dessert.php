		...
		<div class="col-lg-12">
			...
			<ol class="breadcrumb">
				...
				<li class="active">
					...
					<i class="fa fa-dashboard"></i> Dashboard / Add Dessert
			...
			<div class="panel panel-default">
				...
				<div class="panel-heading">
					...
					<h3 class="panel-title">
						...
						<i class="fa fa-monex fa-fw"></i> Add Dessert
...
if(isset($_POST['submit'])){
    ...
    $insert_product = "insert into desszertek (food_name,food_desc,food_price) values ('$product_title','$product_keywords','$product_desc')";
    
    $run_product = mysqli_query($con,$insert_product);
    
    if($run_product){
        
        echo "<script>alert('Dessert added')</script>";
